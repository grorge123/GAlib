/** 
  @file GATree.h  
  @brief This file defines the templatized tree objects.
...
/** @brief GATree is a container for nodes that have a tree structure.
...
alloc and dealloc and recursion.
 ...
 @li @b root, current, next, prev, parent, child, warp
...
/** @brief GATreeIter is a type-safe derivation of the base TreeIter object.
