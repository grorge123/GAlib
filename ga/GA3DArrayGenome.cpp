...
GA3DArrayAlleleGenome<T>::GA3DArrayAlleleGenome(unsigned int w, unsigned int h,
    ...
    this->initializer(
        GA3DArrayAlleleGenome<T>::DEFAULT_3DARRAY_ALLELE_INITIALIZER);
    this->mutator(GA3DArrayAlleleGenome<T>::DEFAULT_3DARRAY_ALLELE_MUTATOR);
    this->comparator(
        GA3DArrayAlleleGenome<T>::DEFAULT_3DARRAY_ALLELE_COMPARATOR);
...
int GA3DArrayGenome<T>::OnePointCrossover(const GAGenome &p1,
    ...
    if (c1 && c2) {
        ...
        } else if (sis.resizeBehaviour(GAGenome::WIDTH) ==
                       GAGenome::FIXED_SIZE ||
                   bro.resizeBehaviour(GAGenome::WIDTH) ==
                       GAGenome::FIXED_SIZE) {
            GAErr(GA_LOC, mom.className(), "one-point cross",
                  gaErrSameBehavReqd);
            return nc;
        ...
        } else if (sis.resizeBehaviour(GAGenome::HEIGHT) ==
                       GAGenome::FIXED_SIZE ||
                   bro.resizeBehaviour(GAGenome::HEIGHT) ==
                       GAGenome::FIXED_SIZE) {
            GAErr(GA_LOC, mom.className(), "one-point cross",
                  gaErrSameBehavReqd);
            return nc;
        ...
        } else if (sis.resizeBehaviour(GAGenome::DEPTH) ==
                       GAGenome::FIXED_SIZE ||
                   bro.resizeBehaviour(GAGenome::DEPTH) ==
                       GAGenome::FIXED_SIZE) {
            GAErr(GA_LOC, mom.className(), "one-point cross",
                  gaErrSameBehavReqd);
            return nc;
